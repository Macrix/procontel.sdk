...
{
  [ConfigurationDialog("RWE.Nuclear.Dialogs.WebHostEndpoint", "WebHostConfigurationDialog")]
  [EndpointMetadata(Name = "[Test] Sdk_Samples_SimpleWebApiEndpoint", SupportedRoles = SupportedRoles.Both)]
  public class WebServerEndpoint : WebHostEndpoint<Startup>, IHandler
  {
    ...
    {
      Logger.Debug($"Handling {messageId}");
      return new Unknown();
    }
  }
}
